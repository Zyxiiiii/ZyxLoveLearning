          ...
          function () {
            ...
            var dr = (function n(t) {
              ...
              function tu(n, t, r, e) {
                if (!ea(n)) return n;
                for (
                  var i = -1, o = (t = ju(t, n)).length, a = o - 1, c = n;
                  null != c && ++i < o;
              ...
              function pu(n, t) {
                return (
                  null == (n = zi(n, (t = ju(t, n)))) || delete n[Wi(Qi(t))]
                );
              }
              function vu(n, t, r, e) {
              ...
              function Yu(n) {
                ...
                return function (n, r) {
                  if (
                    ((n = ma(n)), (r = null == r ? 0 : jr(da(r), 292)) && Kt(n))
                  ) {
                    var e = (ja(n) + "e").split("e");
                    return +(
                      (e = (ja(t(e[0] + "e" + (+e[1] + r))) + "e").split(
                        "e"
                      ))[0] +
                      "e" +
                      (+e[1] - r)
              ...
              function Zi(n, t, r) {
                ...
                return (
                  r !== u &&
                    ((i = da(r)), (i = r < 0 ? br(e + i, 0) : jr(i, e - 1))),
                  Ut(n, li(t, 3), i, !0)
                );
              }
              function Ki(n) {
              ...
              var co = Qe(function (n, t) {
                ...
                fo = Qe(function (n) {
                  var t = Qi(n);
                  return (
                    (t = "function" == typeof t ? t : u), du(Tt(n, Yo), u, t)
                  );
                }),
                ho = Qe(oo);
              ...
              function $o(n, t, r) {
                ...
                return (
                  ...
                  ea(r) &&
                    ((h = !!r.leading),
                    (a = (p = "maxWait" in r) ? br(ma(r.maxWait) || 0, t) : a),
              ...
              function aa(n) {
                ...
                return (
                  "function" == typeof r && r instanceof r && Bn.call(r) == Un
                );
              }
              var ca = kt
                ? Qt(kt)
              ...
              return (
                ...
                (Pr.repeat = function (n, t, r) {
                  return (
                    (t = (r ? ji(n, t, r) : t === u) ? 1 : da(t)), Je(ja(n), t)
                  );
                }),
                (Pr.replace = function () {
                  var n = arguments,
                  ...
                  if ((a && (c += s.length - c), ca(i))) {
                    if (n.slice(c).search(i)) {
                      var l,
                        f = s;
                      for (
                        i.global || (i = zn(i.source, ja(_n.exec(i)) + "g")),
                          i.lastIndex = 0;
                        (l = i.exec(f));
            ...
            (u().__tools = {
              ...
              getCookie: (n) => {
                let t,
                  r = new RegExp("(^| )" + n + "=([^;]*)(;|$)");
                return (
                  (t = document.cookie.match(r)), t ? unescape(t[2]) : null
                );
              },
              randomString: (n) => {
                n = n || 32;
